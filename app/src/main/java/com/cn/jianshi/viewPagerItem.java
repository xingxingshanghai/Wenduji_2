...
public class viewPagerItem extends LinearLayout implements View.OnClickListener{
    ...
    public viewPagerItem(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.context= (RiliActivity) context;
    }
    ...
    public void onClick(View v) {
       ...
       if(dateBean.isNeedFlag())
           ...
           Toast.makeText(context,"没记录", Toast.LENGTH_SHORT).show();
        ...
        context.initview(dateBean.getStrDateNew());
//        }
//        else
//            Toast.makeText(context,"当天没有监测记录", Toast.LENGTH_SHORT).show();
    }
}
